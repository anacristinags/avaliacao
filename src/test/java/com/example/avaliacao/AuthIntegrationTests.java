...
import com.example.avaliacao.service.JwtService;
...
class AuthIntegrationTests {
    ...
    void setup() {
        userRepository.findByUsername("admin").ifPresentOrElse(
                user -> { /* Já existe */ },
                () -> {
                    com.example.avaliacao.model.User admin = new com.example.avaliacao.model.User(null, "admin", passwordEncoder.encode("123456"), "ROLE_ADMIN");
        ...
        userRepository.findByUsername("user").ifPresentOrElse(
                user -> { /* Já existe */ },
                () -> {
                    com.example.avaliacao.model.User regularUser = new com.example.avaliacao.model.User(null, "user", passwordEncoder.encode("password"), "ROLE_USER");
